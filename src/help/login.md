...
We really hope we are not in this situation again! The Auth0 account we are on is more suited for Mythic's requirements and is not a development product. However, long term we would like to explore managing user accounts within the Mythic app. This would give us full control, though it does come with its own challenges. If we do decide to go this route, there are a couple of options that may streamline the transition. The goal would be to have plenty of time to implement a solution and work with users on the transition.
